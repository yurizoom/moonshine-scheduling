<div x-data="data()">
    ...
    <x-moonshine::box xmlns:x-moonshine="http://www.w3.org/1999/html" title="{{ __('moonshine-scheduling::scheduling.output') }}"
                      x-show="output">
        <pre style="white-space:pre-wrap;background: #000000;color: #00fa4a;padding: 10px;border-radius: 0;"></pre>
    </x-moonshine::box>
</div>
